                                    ...
                                    <div class="flex items-center mb-3">
                                        <input
                                            ...
                                            class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
                                             {{-- Check if category is selected (old input or initial selection) and set checkbox 'checked' attribute --}}
                                            {{ in_array($category->id, old('categories', $categoriesArray ?? [])) ? 'checked' : '' }}
                                        >
                                        <label
                                ...
                                @foreach($tags as $tag)
                                    <div class="flex items-center mb-3">
                                        <input
                                            ...
                                            id="tag-{{ $tag->id }}"
                                            class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
                                            {{-- Check if tag is selected (old input or initial selection) and set checkbox 'checked' attribute --}}
